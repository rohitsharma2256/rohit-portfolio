...
export default function Hero() {
  ...
  // Zowork-style staggered fade-up — slower, more premium easing
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      {/* Zowork-style slow-drifting ambient orbs */}
      <div className="ambient-orb w-[600px] h-[600px] bg-brand-500/10 -top-40 -left-40" />
      <div className="ambient-orb w-[500px] h-[500px] bg-purple-400/8 bottom-0 right-0" style={{ animationDelay: '4s' }} />
      <div className="ambient-orb w-[350px] h-[350px] bg-blue-400/6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ animationDelay: '8s' }} />

      {/* Subtle particle dust behind avatar, Zowork logo style */}
      <div className="dust-field hidden lg:block" style={{ right: '8%', top: '15%', width: '480px', height: '480px', left: 'auto' }} />
      ...
      <div className="relative max-container px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            {/* Zowork-style eyebrow badge with pulsing dot */}
            ...
            {/* Zowork-style large heading with gradient second line */}
            <motion.h1 {...fadeUp(0.25)} className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-4 tracking-tight leading-[1.05]">
              <span className="text-[var(--fg)]">Rohit </span>
              <span className="gradient-text">Sharma</span>
            </motion.h1>

            <motion.div {...fadeUp(0.35)} className="h-10 flex items-center mb-6">
            ...
            <motion.div {...fadeUp(0.4)} className="flex items-center gap-5 mb-6 text-xs text-[var(--muted)]">
            ...
            <motion.p {...fadeUp(0.5)} className="text-[var(--muted)] text-base max-w-xl mb-10 leading-relaxed">
          ...
          >
            ...
            {/* Code card — glass-card style */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.9, ease: [0.16, 1, 0.3, 1] }}
              className="code-block glass-card w-full max-w-sm text-left"
            >
