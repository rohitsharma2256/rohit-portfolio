      ...
      <div className="max-container relative" ref={ref}>
        ...
        >
          ...
          <p className="text-[var(--muted)] text-sm max-w-lg mx-auto">
            Real projects, real commits. Every repository represents an engineering challenge I tackled end-to-end.
          </p>
        </motion.div>
        ...
        >
          <a href={`https://github.com/${USERNAME}`} target="_blank" rel="noopener noreferrer" className="btn-ghost inline-flex">
            <Github size={18} />
